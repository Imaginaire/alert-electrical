...
export default function Newsletter({newsletter}: {newsletter: NewsletterType}) {
  return (
    <div className="bg-secondary-grey px-7 py-12 ">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:gap-5 items-center justify-center ">
        ...
        <div className="flex w-full max-w-4xl lg:w-full flex-1 mt-7 md:mt-0">
